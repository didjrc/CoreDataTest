...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
	...
	//added from github.com/objcio/issue-4-full-core-data-application/
	UINavigationController* navigationController = (UINavigationController*) self.window.rootViewController;
	DataLogTableViewController *rootViewController = (DataLogTableViewController *)navigationController.topViewController;
	NSAssert([rootViewController isKindOfClass:[DataLogTableViewController class]], @"Should have an item view controller");
...
- (NSURL *)modelURL
{
	return [[NSBundle mainBundle] URLForResource:@"EczemamaDataModel" withExtension:@"momd"];
}
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.DIC.debug_count_logger" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"debug_count_logger" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"debug_count_logger.sqlite"];
    NSError *error = nil;
